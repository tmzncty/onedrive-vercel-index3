...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'tianci@mobichenghui.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/tmzncty',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/tmzncty',
    },
  ],
